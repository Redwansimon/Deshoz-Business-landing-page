        ...
        <section className='py-16 px-4 max-w-7xl mx-auto'>
            ...
            <div className="relative ">
                ...
                >
                    {
                        testimonials.map((testimonial, index) => (
                            <SwiperSlide className='h-full md:py-12 py-4' key={index}>
                                <div className='text-center bg-white p-4 rounded-lg shadow-lg h-full flex flex-col '>
                ...
                <div className="flex justify-center gap-4 mt-4 md:mt-8">
                    <button className='swiper-button-prev-custom  w-12 h-12 rounded-full border-gray-200 flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all cursor-pointer'>
                        <BsChevronLeft className='size-6' />
                    </button>
                    <button className='swiper-button-next-custom w-12 h-12 rounded-full border-gray-200 flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all cursor-pointer'>
