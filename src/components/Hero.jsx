        ...
        <div>
            <section id="home" className="container mx-auto pt-44 pb-16 px-8 sm:px-6  lg:px-8 flex flex-col md:flex-row justify-between items-center">
                ...
                <div className=" w-full md:w-1/2 space-y-8">
                    ...
                    <p className=" text-gray-600 text-lg md:text-xl max-w-xl">Get the most accurate leads, sales people training and conversions, tools and more - all within the same one billing.
                    </p>
